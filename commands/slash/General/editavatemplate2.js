...
module.exports = {
  ...
  options: [
    ...
    },
    {
      name: "field",
      description:
        "The field you want to edit (title, date-time, description, image)",
      type: 3,
      required: true,
    },
    {
      name: "value",
      description:
        "The new value for the field (Date and Time must be in the format: YYYY-MM-dd HH:MM (24 hour format))",
      type: 3,
      required: true,
    },
  ],
  ...
  run: async (client, interaction, config) => {
    ...
    if (
      ...
      message.embeds[0].footer.text !== "Made By INFINITY"
    ) {
